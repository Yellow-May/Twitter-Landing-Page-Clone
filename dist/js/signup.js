...
for (let index = 1; index <= 31; index++) {
    ...
    daySelect === null || daySelect === void 0 ? void 0 : daySelect.append(opt);
}
for (let index = 0; index < 12; index++) {
    ...
    opt.value = month;
    opt.innerText = month;
    monthSelect === null || monthSelect === void 0 ? void 0 : monthSelect.append(opt);
}
for (let index = new Date().getFullYear() - 15; index >= 1900; index--) {
    const opt = document.createElement("option");
    opt.value = index.toString();
    opt.innerText = index.toString();
    yearSelect === null || yearSelect === void 0 ? void 0 : yearSelect.append(opt);
}
let switchType = true;
